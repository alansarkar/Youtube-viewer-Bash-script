...
#echo -e  "\e[1;33m$(cat /home/$(whoami)/.ytcache  | sed 's/.*"  title="//g' | sed 's/" aria.*//g'| sed 's/rel="spf-prefetch//g'| head -$y | tail -1)\e[0m"
echo -e "\e[1;31m$(cat /home/$(whoami)/.ytcache | sed 's/.*"  title="//g' | sed 's/" aria.*//g'| sed 's/" rel="spf-prefetch//g'| head -$y | tail -1)\e[0m"
...
echo " "
echo -e "\e[1;31m$(cat /home/$(whoami)/.ytcache | cut -c282-400 | sed 's/.*title="//g' | sed 's/" aria.*//g'| sed 's/rel="spf-prefetch//g'| head -$p | tail -1)\e[0m"
